...
- Verification: focused RED/GREEN tests and the CPA puller/supervisor/storage-gate/sentinel suite passed 218/218. The live sentinel completed exit 0 with no `--dry-run`; its old traceback log mtime remains 2026-08-12.
