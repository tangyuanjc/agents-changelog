...
- APFS evidence: Data Available was `19,133,316 KiB` at task baseline and `17,763,152 KiB` at the closing readback. The decrease is reported as background/swap drift, not recovery; no `du` value was claimed as exclusive or reclaimable APFS capacity.
