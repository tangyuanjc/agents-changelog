...
- Employee pilot: `WS-2061` is a new v2 ticket assigned to 奶思的猪猪 and is currently running on the employee machine. It must produce only a local employee-controlled receipt; `WS-1889` v1 is not reused as v2 evidence, and CTO/Sol cannot author the employee review, second-person adoption or independent business outcome.
